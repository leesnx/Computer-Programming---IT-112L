...
Programming Date: 10/10/2022
Activity Number: Midterm Exercise 2
*/
...
3. Declare and initialize the variable perfectExamScore that represents the perfect score for the
examination.
4. Declare and initialize the variable examScore that represents the examination score of a
student.
...
7. Declare and initialize the variable numericGrade that represents the numeric prelim grade of a
student.
8. Declare and initialize the variable letterGrade that represents the letter prelim grade of a
student.
9. Declare and initialize the variable studentName that represents the name of a student.
10. Display a message that explains that the running program is a utility for computing the prelim
grade of a student.
...
displayed on the screen and the program execution should end. 14.Read the perfect score for the examination from the keyboard. The perfect score read must be
validated such that it cannot be less than or equal to zero. If the user enters an invalid perfect
score, an appropriate error message should be displayed on the screen and the program execution
should end. 15. Read the examination score of the student. The score read must be validated such that the
...
screen and the program execution should end. 16. Compute grade of the student for the quizzes through the formula:
